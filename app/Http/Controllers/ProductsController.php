...
class ProductsController extends Controller
{
    ...
    public function index($id, $sub_cat_id = null)
    {
        ...
        return view('public.products')->with('products', $tempArr)
            ->with('sub_categories', $sub_categories)->with('cat_id', $id)->with('owner_id',$owner_id->user_id );
    }
